...
const ParticleField = () => {
  // 📱 Fewer particles on mobile = less repaint cost, smoother scroll
  ...
  return (
    // 📱 Hide entirely on the smallest screens to eliminate scroll jank
...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20 lg:py-0">
        {/* 📱 Mobile/tablet: image on top, content below — centered.
            🖥 Desktop (lg+): content left, image right — side by side. */}
        <div className="flex flex-col lg:flex-row-reverse items-center justify-center lg:justify-between gap-8 sm:gap-10 lg:gap-16">
          ...
          {heroPhoto && (
            ...
            >
              <motion.div
                ...
                className="relative"
              >
                <div className="w-32 h-32 sm:w-44 sm:h-44 md:w-56 md:h-56 lg:w-72 lg:h-72 xl:w-80 xl:h-80 rounded-full overflow-hidden border-2 border-primary/30 shadow-lg shadow-primary/20">
          ...
          {/* Text content — below on mobile (centered), left on desktop (left-aligned) */}
          <div className="flex-1 text-center lg:text-left w-full">
            <motion.h1
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.7, delay: 0.2 }}
              className="fluid-h1 font-bold tracking-tight mb-3"
            >
            ...
            <motion.div
              ...
              className="mb-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-1 sm:gap-2"
            >
